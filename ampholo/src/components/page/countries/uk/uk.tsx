...
import { UKService } from "../../../services/countries/uk-service";

const routes = ["/about", "/countries", "/features", "/contact-us"] as const;

export const UKHero = () => {
  const { form, onSubmit, fields, append, remove } = UKService();
    ...
    <div id="hero" className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 py-12 ">
        ...
        <div className="text-center mb-5">
          <Header className="text-gray-800">UK Hero Section</Header>
          <Paragraph className="text-gray-600">Customize the UK Hero section below.</Paragraph>
        </div>
