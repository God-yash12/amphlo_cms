...
import { CanadaService } from "../../../services/countries/canada-service";
...
export const CanadaHero = () => {
  const { form, onSubmit, fields, append, remove } = CanadaService();
    ...
    <div id="hero" className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 py-12 ">
        ...
        <div className="text-center mb-5">
          <Header className="text-gray-800">Canada Hero Section</Header>
          <Paragraph className="text-gray-600">Customize the Canada Hero section below.</Paragraph>
        </div>
