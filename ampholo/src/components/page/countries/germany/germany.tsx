...
import { GermanyService } from "../../../services/countries/germany-service";
import { ErrorMessage } from "../../../../ui/typographs/error-message";

const routes = ["/about", "/countries", "/features", "/contact-us"] as const;

export const GermanyHero = () => {
  const { form, onSubmit, fields, append, remove } = GermanyService();
    ...
    <div id="hero" className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 py-12 ">
        ...
        <div className="text-center mb-5">
          <Header className="text-gray-800">Germany Hero Section</Header>
          <Paragraph className="text-gray-600">Customize the Germany Hero section below.</Paragraph>
        </div>
