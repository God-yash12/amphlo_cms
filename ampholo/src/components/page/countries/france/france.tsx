...
import { FranceService } from "../../../services/countries/france-service";

const routes = ["/about", "/countries", "/features", "/contact-us"] as const;

export const FranceHero = () => {
  const { form, onSubmit, fields, append, remove } = FranceService();
    ...
    <div id="hero" className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 py-12 ">
        ...
        <div className="text-center mb-5">
          <Header className="text-gray-800">France Hero Section</Header>
          <Paragraph className="text-gray-600">Customize the France Hero section below.</Paragraph>
        </div>
