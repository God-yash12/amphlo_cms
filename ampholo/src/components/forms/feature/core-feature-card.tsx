                ...
                <div className="mx-auto">
                    <FormProvider {...form} >
                        ...
                        >
                            ...
                            {/* Submit Button */}
                            <div className="pt-6">
                                <PrimaryButton type="submit" disabled={isLoading} className="w-full text-center">{isLoading ? <div><BeatLoader /></div> :  <div>{selectedCoreFeatureCard ? "Update" : "Submit"}</div>}</PrimaryButton>
                            </div>
                        </form>
                    </FormProvider>
                </div>
