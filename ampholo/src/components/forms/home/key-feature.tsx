            ...
            <div ref={formRef} className="container bg-white rounded-lg shadow-sm p-4 md:p-6 lg:p-8 border-1 border-blue-gray-800 grid lg:grid-cols-3 gap-6">
                ...
                <div className="col-span-1 max-w-2xl mx-auto mb-12">
                    ...
                    <Paragraph className="text-gray-600 text-left">
                        Customize and manage your website's Home page Key Feature Card section Cards
                    </Paragraph>
                </div>
                    ...
                    <FormProvider {...form}>
                        ...
                        >
                            ...
                            <div className="pt-4 border-t flex justify-center">
                                <PrimaryButton type="submit" disabled={isLoading} className="w-full px-10 text-center">{isLoading ? <div><BeatLoader /></div> : <div>{selectedKeyFeatureCard ? "UPDATE" : "SUBMIT"}</div>}</PrimaryButton>
                            </div>
                        </form>
                    </FormProvider>
                </div>
