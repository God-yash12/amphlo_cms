...
const KeyFeaturesForm = () => {
  const { register, handleSubmit, setValue } = KeyFeaturesFormService();
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-2xl mx-auto text-center mb-12">
          <Header className="text-3xl font-bold text-gray-900 mb-4">
            Key Features Cards Management
          </Header>
          <Paragraph className="text-gray-600">
            Customize and manage your website's key features section Cards to highlight your main offerings
          </Paragraph>
        </div>
